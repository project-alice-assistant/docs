...
Project Alice comes with 5 pre installed modules, but you can extend this by adding others which you can find on [https://store.projectalice.io](https://store.projectalice.io) or directly on Alice's interface.
...
## Skills
Adding new features to Alice is possible by installing new skills. The skill store is also on device, but you'll need internet connectivity to fetch the list of available skills and install them. We also have an online skill store you can visit from your computer, mobile etc.: [https://store.projectalice.io](https://store.projectalice.io)
